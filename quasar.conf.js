  ...
  return {
    ...
    build: {
      ...
      env: ctx.dev
        ? // Running in Developement
          {
            VUE_APP_API_URL: 'http://127.0.0.1:9999',
            VUE_APP_TITLE: 'DEV Berichtsheft',
            STRIPE_PUBLISHABLE_KEY:
              'pk_test_51I5FxLGJ5kaOMHSUOvn0A6e2O1Wu6Ls892AMmbxxQiqkf6w5g3HI8plB4QcoIG5260C06DL1p6NCH3U8ss1BjNN300eDVVZJc5',
          }
        : // Running in Production
          {
            VUE_APP_API_URL: 'https://berichtsheft-restapi-test.herokuapp.com',
            VUE_APP_TITLE: 'Berichtsheft',
            STRIPE_PUBLISHABLE_KEY:
              'pk_test_51I5FxLGJ5kaOMHSUOvn0A6e2O1Wu6Ls892AMmbxxQiqkf6w5g3HI8plB4QcoIG5260C06DL1p6NCH3U8ss1BjNN300eDVVZJc5',
          },
        ...
        if (prerender) {
          cfg.plugins.push(
            new PrerenderSPAPlugin({
              ...
              // Path to Prerendered Routes
              //outputDir: path.join(__dirname, 'dist/spa/prerendered'),

              // Tell the Pre-SPA plugin not to use index.html as its template file.
              //indexPath: path.join(__dirname, 'dist/spa', 'app.html'),
    ...
    pwa: {
      ...
      manifest: {
        ...
        description: 'Das digitale Berichtsheft',
        display: 'standalone',
